<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody>
        ...
        <tr>
            <td colspan="7" align="center" valign="bottom" style="font-size: 8;text-align: center; font-weight: bold;">TRIAL BALANCE SUMMARY</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        ...
        @foreach($reportData as $data)
            <tr>
                <td>{{ $data['general_account'] }}</td>
                <td>{{ $data['general_name'] }}</td>
                <td style="font-size: 8; text-align: right;">{{ number_format($data['beginning_balance'], 2, ',', '.') }} {{ $data['bbs'] }}</td>
        ...
        <tr>
            <td></td>
            <td><strong>CURRENT MONTH PROFIT/LOSS</strong></td>
            <td></td>
